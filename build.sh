...
A_FLAGS="-D CMAKE_CXX_COMPILER=${WHERE}/kokkos/bin/nvcc_wrapper -D Athena_ENABLE_MPI=On -D Kokkos_ENABLE_CUDA=On -D Kokkos_ARCH_AMPERE80=On -D Kokkos_ARCH_NATIVE=ON -D PROBLEM=${problem} -B build_${problem} -D Kokkos_ENABLE_SERIAL=OFF -D Kokkos_ENABLE_OPENMP=ON"
